The preprocessor reads in the source files of a given directory and outputs a generated file with various useful functions. It\textquotesingle{}s mostly based on a \mbox{\hyperlink{PreprocTest_8h_a2606cd56d2d8f567785bde5848176722}{T\+A\+G()}} pre-\/define with the various add-\/ons desired.
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_PreprocessorUsage_autotoc_md6}{}\doxysection{Enum Class Tags}\label{md_PreprocessorUsage_autotoc_md6}
...
\end{DoxyCode}
\hypertarget{md_PreprocessorUsage_autotoc_md7}{}\doxysubsection{Strings}\label{md_PreprocessorUsage_autotoc_md7}
Usage\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{PreprocTest_8h_a2606cd56d2d8f567785bde5848176722}{TAG}}(Strings)}
\DoxyCodeLine{\textcolor{keyword}{enum class} \mbox{\hyperlink{PreprocTest_8h_a081cf1a0e70d6e2bd48c98f457742877}{enColours}}}
...
\DoxyCodeLine{\mbox{\hyperlink{PreprocTest_8h_a081cf1a0e70d6e2bd48c98f457742877}{enColours}} \mbox{\hyperlink{Generated__Test_8h_ad369bcb4826dc155da6b130a0fa97d13}{StringToEnum<enColours>}}(st\_ptr);}
\DoxyCodeLine{constexpr st\_ptr \mbox{\hyperlink{Generated__Test_8h_ad639153996de58e57408c83a3dcc9257}{EnumToString}}(\mbox{\hyperlink{PreprocTest_8h_a081cf1a0e70d6e2bd48c98f457742877}{enColours}});}
\end{DoxyCode}
...
\end{DoxyCode}
\hypertarget{md_PreprocessorUsage_autotoc_md8}{}\doxysubsection{J\+S\+ON}\label{md_PreprocessorUsage_autotoc_md8}
...
\end{DoxyCode}
\hypertarget{md_PreprocessorUsage_autotoc_md9}{}\doxysubsection{Label}\label{md_PreprocessorUsage_autotoc_md9}
...
\end{DoxyCode}
\hypertarget{md_PreprocessorUsage_autotoc_md10}{}\doxysection{Structs}\label{md_PreprocessorUsage_autotoc_md10}
\hypertarget{md_PreprocessorUsage_autotoc_md11}{}\doxysubsection{J\+S\+ON}\label{md_PreprocessorUsage_autotoc_md11}
...
\end{DoxyCode}
\hypertarget{md_PreprocessorUsage_autotoc_md12}{}\doxysection{State Machine}\label{md_PreprocessorUsage_autotoc_md12}
...
Usage\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{PreprocTest_8cpp_a10c8440d867f5c4661fb661d0a498f0a}{STATEMACHINE}}(base\_name, struct\_name, cmd\_enum\_name \textcolor{comment}{/*, <other types for functions*/});}
\end{DoxyCode}
...
\DoxyCodeLine{b8 \mbox{\hyperlink{Generated__Test_8h_aacf77a00c47b027a4331328a1071854c}{EnqueueCommand}}(cmd\_enum\_name\_queue *Queue, cmd\_enum\_name Cmd);}
\DoxyCodeLine{cmd\_enum\_name \mbox{\hyperlink{Generated__Test_8h_aa431f033dae8e03ce9f9e76c5897d077}{DequeueCommand}}(cmd\_enum\_name\_queue *Queue);}
\DoxyCodeLine{}
...
\DoxyCodeLine{b8 \mbox{\hyperlink{Generated__Test_8h_aacf77a00c47b027a4331328a1071854c}{EnqueueCommand}}(struct\_name *State, cmd\_enum\_name Cmd);}
\DoxyCodeLine{cmd\_enum\_name \mbox{\hyperlink{Generated__Test_8h_aa431f033dae8e03ce9f9e76c5897d077}{DequeueCommand}}(struct\_name *State);}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{PreprocTest_8cpp_a10c8440d867f5c4661fb661d0a498f0a}{STATEMACHINE}}(test\_statemachine, \mbox{\hyperlink{structtest__type}{test\_type}}, \mbox{\hyperlink{PreprocTest_8h_a55ed691059222a58555cf9992ec14431}{test\_cmd}}, \textcolor{keywordtype}{int} SomeInt, \textcolor{keywordtype}{char} \textcolor{keyword}{const} *AString);}
\DoxyCodeLine{}
...
\DoxyCodeLine{\{}
\DoxyCodeLine{    \mbox{\hyperlink{PreprocTest_8h_a55ed691059222a58555cf9992ec14431}{test\_cmd}} = \mbox{\hyperlink{Generated__Test_8h_aa431f033dae8e03ce9f9e76c5897d077}{DequeueCommand}}(State);}
\DoxyCodeLine{    \textcolor{comment}{// Code Here}}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_PreprocessorUsage_autotoc_md13}{}\doxysection{J\+S\+ON}\label{md_PreprocessorUsage_autotoc_md13}
