...
#if !defined(_AB_GENERATED_HEADER_GENERATEDTEST_PREPROCESSOR_)
#define _AB_GENERATED_HEADER_GENERATEDTEST_PREPROCESSOR_
...
@param NewState The function name of the target state, generated by `TEST_STATEMACHINE()`.
...
#endif // _AB_GENERATED_HEADER_GENERATEDTEST_PREPROCESSOR_

#if defined(GENERATEDTEST_PREPROCESSOR_SRC)
#undef GENERATEDTEST_PREPROCESSOR_SRC
               ...
               ((Token+1)->type == JSMN_STRING)) 
{
    ...
    s32 Length = MINIMUM(TokenLength+1, (50-1));
...
#endif // GENERATEDTEST_PREPROCESSOR_SRC
