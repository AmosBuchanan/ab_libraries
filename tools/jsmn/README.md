...
This file was copied from the above repository and modified slightly to work as a single-file header similar to others in the amos_library folder. The functions have been entirely unchanged from the original.